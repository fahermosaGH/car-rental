...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: AtencionClienteComponent, // Asegúrate que esta ruta sea correcta.
      },
      {
        path: 'login',
      ...
      {
        path: 'requisitos-alquiler',
        component: RequisitosAlquilerComponent,
      },
      {
        path: 'mejor-precio',
        component: MejorPrecioComponent,
      },
    ],
  },
